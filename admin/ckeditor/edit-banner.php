...
if (isset($_GET['id'])){
	$id=$_GET['id'];
	$ban=mysqli_query($conn,"SELECT * FROM banner WHERE id=$id");
	$banner=mysqli_fetch_assoc($ban);
}
...
if (isset($_POST['name'])){
	...
	if (isset($_FILES['image'])){
		...
		if (empty($file['name'])){
			...
			unlink('../uploads/banner/'.$pro['image']);
					...
					<table class="table table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<a href="delete-cate.php?id=<?php echo $value['id'] ?>" class="btn btn-danger"><i class="fa fa-fw fa-remove"></i></a>
								</span>
								</td>
