...
<!-- Quản lý sản phẩm -->
          <li class="treeview" style="height: auto;">
            <a href="#">
              <i class="fa fa-fw fa-image"></i> <span>Quản lý sản phẩm</span>
            ...
            <ul class="treeview-menu" style="display: none;">
              ...
              <li><a href="add-pro.php"><i class="fa fa-circle-o"></i>Thêm mới sản phẩm</a></li>
            </ul>
          ...
          <li class="treeview" style="height: auto;">
            <a href="#">
              <i class="fa fa-fw fa-image"></i> <span>Quản lý đơn hàng</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu" style="display: none;">
              <li><a href="order.php"><i class="fa fa-circle-o"></i>Danh sách đơn hàng</a></li>
            </ul>
          </li>
