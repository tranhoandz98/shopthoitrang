...
$new_product = mysqli_query($conn,"SELECT * FROM product WHERE status = 1");
...
$query=mysqli_query($conn,"SELECT * FROM product WHERE status = 1 ORDER BY id DESC LIMIT $start,$limit ");
